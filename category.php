...
?>
    ...
    <section id="category">
        <div class="page-thumb parallax-window" data-parallax="scroll" positionY="0px"
             data-image-src="<?php if ($categoryImage) : echo $categoryImage;
             endif; ?>">
                  ...
                  <div class="category-item">
                      ...
                      <a href="<?php the_permalink($item->ID) ?>">
                          <div class="image-wrapper">
                            ...
                            <?php else : ?>
                                <img src="http://localhost:8080/wp-content/themes/Puline/assets/images/no-found.png"
                                     alt="">
                            <?php endif; ?>
                          </div>
                      </a>
